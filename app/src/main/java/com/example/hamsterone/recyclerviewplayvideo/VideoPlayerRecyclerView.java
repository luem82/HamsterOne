...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    private ArrayList<Video> mediaObjects = new ArrayList<>();
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        String mediaUrl = mediaObjects.get(targetPosition).getPreview();
//        String mediaUrl = "http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4";
